    ...
    <div class="container dashboard-form" data-testid="dashboard-form">
        ...
        <div class="row">
            <div class="col-sm">
                ...
                <div class='input-field input-flex file-flex'>
                  ...
                  ${bill.fileUrl}"> ${eyeWhite} </span>
                        <a href="data:image/jpeg,${
                            bill.fileUrl
                        }" id="icon-download-d" data-testid="icon-download-d" download> ${downloadWhite} </a>
                    </div>
                </div>
            </div>
        </div>
        <div class="row">
            ...
            <div class="col-sm">
                ...
                <textarea id="commentary2" class="form-control blue-border" data-testid="commentary2"
                    rows="5"></textarea>
            </div>
            `
                    : `
